    ...
    return (
        level ? level === 1 ?
            <div className="text-center mb-8 sm:mb-10">
                ...
                <div className="text-center mb-8 sm:mb-10 flex flex-row max-w-[85dvw] mx-auto">
                    <Button className="w-[10%] tw-ring-transparent offset-ring-transparent focus:border-none active:border-none !p-0" variant="icon" onClick={goBack}>
